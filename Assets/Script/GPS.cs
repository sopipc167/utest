...
public class GPSManager : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        ...
        String lgt_txt = String.Format("현재 위도:");
        String lat_txt = String.Format("현재 위도:");
        //String lgt_txt = String.Format("현재 위도:{0}",current_Lat);
        //String lat_txt = String.Format("현재 경도:{0}", current_Long);
